define([`com/hid/TransactionSigningWithoutUI/txnSigningPresentationController`],function(txnSigningPresentationController) {
  ...
  transactionSigningConstants.UNREGISTERED_EVENT = kony.i18n.getLocalizedString("i18n.hid.txn.internalError");
  transactionSigningConstants.INVALID_USERNAME = kony.i18n.getLocalizedString("i18n.hid.login.invalid_username");
  transactionSigningConstants.INVALID_TDS = kony.i18n.getLocalizedString("i18n.hid.txn.invalidTDSMessage");
  transactionSigningConstants.INVALID_ACCOUNT = kony.i18n.getLocalizedString("i18n.hid.txn.invalidAccount");
  transactionSigningConstants.INVALID_AMOUNT = kony.i18n.getLocalizedString("i18n.hid.txn.invalidAmount");
  transactionSigningConstants.INVALID_DESC = kony.i18n.getLocalizedString("i18n.hid.txn.invalidDescription");
  transactionSigningConstants.INVALID_OTP = kony.i18n.getLocalizedString("i18n.hid.txn.invalidOTP");
  transactionSigningConstants.INVALID_SIGN_CONTENT = kony.i18n.getLocalizedString("i18n.hid.txn.invalidTxnContents");
  transactionSigningConstants.authType = "AT_OOBSMS";
  /*
  NOTE: 
    Based on the MFA selection from the Login component, 
    "transactionSigningConstants.authType" value could be AT_OOBSMS for "OTP_SMS" MFA Factor 
    or AT_OOBEML for "OTP_EML" MFA Factor.
  */
  ...
  return {
    ...
    sendSMSOTP : function(username){
      if(username === null){
        throwCustomException(transactionSigningConstants.INVALID_USERNAME);
      } 
      this.correlationId = this.transactionCorrelationIdPrefix+this.generateUUID();
      txnSigningPresentationController.sendSMSOTP(this.commonEventHandler, username, transactionSigningConstants.authType, this.correlationId);      
    },
