define([`com/hid/userManagement/UserManagementBusinessController`], function(UserManagementBusinessController)  {
  ...
  UserManagementPresentationController.prototype.searchUserAttributes = function(username, S_CB, F_CB){
    let params = {"username" : username };
    UserManagementBusinessController.searchUserAttributes(params, S_CB, F_CB);
  };

  UserManagementPresentationController.prototype.getUserAttributes = function(username, correlationId, S_CB, F_CB){
    let params = {"username" : username, "correlationId": correlationId };
    UserManagementBusinessController.getUserAttributes(params, S_CB, F_CB);
  };

  UserManagementPresentationController.prototype.updateAttributes = function(username, email,mobile,firstname,lastname,externalId,correlationId, S_CB, F_CB){
    let params = {"username" : username, "email" : email, "mobile" : mobile, "firstname" : firstname, 
                "lastname" : lastname, "externalId" : externalId, "correlationId": correlationId };
    UserManagementBusinessController.updateAttributes(params, S_CB, F_CB);
  };
