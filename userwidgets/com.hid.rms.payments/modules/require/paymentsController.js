define(["com/hid/rms/payments/PaymentsBusinessController"],function(PaymentsBusinessController) {
  ...
  paymentsConstants.INVALID_PLATFORM = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_platform_config");
  paymentsConstants.PLATFORM_MISMATCH = kony.i18n.getLocalizedString("i18n.hid.txn.platform_mismatch");
  paymentsConstants.INVALID_TM_TAG = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_tm_cookie_tag");
  paymentsConstants.INVALID_TM_SID = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_tm_cookie_sid");
  paymentsConstants.INVALID_CUR = kony.i18n.getLocalizedString("Invalid Request,currency type incorrect");
  paymentsConstants.INVALID_PAYMENT_TYPE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_payment_type");
  paymentsConstants.INVALID_SOURCE_PAYMENT_MODE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_source_payment_mode");
  paymentsConstants.INVALID_PATNER_PAYMENT_MODE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_partner_payment_mode");
  paymentsConstants.INVALID_REQ_OBJECT = kony.i18n.getLocalizedString("i18n.hid.txn.request_not_object")
  paymentsConstants.INVALID_REQ_MISSING = kony.i18n.getLocalizedString("i18n.hid.txn.request_missing");
  paymentsConstants.HID_RMS_SDK_MANAGER_MISSING = kony.i18n.getLocalizedString("i18n.hid.txn.missing_sdk_file");
  ...
  paymentsConstants.INVALID_SECURITY_ITEM_TYPE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_security_item_type");
  paymentsConstants.INVALID_SIGNATURE_STATE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_signature_state");
  paymentsConstants.INVALID_PAYMENT_STATE = kony.i18n.getLocalizedString("i18n.hid.txn.invalid_payment_state");
  let reqBaseTemplate = {
    app_user_id : false,
    amount : false,
