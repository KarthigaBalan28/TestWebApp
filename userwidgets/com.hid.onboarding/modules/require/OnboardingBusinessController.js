define([], function() {
  ...
  OnboardingBusinessController.prototype.getDevice = function(params , S_CB,F_CB){
        let objectService = HIDObjectServices.getRepository('GetDevice');
        const callback = (status, response) => {
            if(status){
                S_CB(response);
            }else{
        ...
        objectService.customVerb('getDevice',params,callback);
        
  };

  OnboardingBusinessController.prototype.updateFriendlyName = function(params , S_CB,F_CB){
        let objectService = HIDObjectServices.getRepository('UpdateFriendlyName');
        const callback = (status, response) => {
            if(status){
                S_CB(response);
            }else{
        ...
        objectService.customVerb("updateFriendlyName",params,callback);
