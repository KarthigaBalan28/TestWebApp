define([`com/hid/transactionSigning/transactionSigningPresentationController`],function(transactionSigningPresentationController) {
  ...
  return {
    ...
    updateTSUI : function(response){
      ...
      switch(response.state){
        ...
        case "approveTransactInitiateFailure" :
          ...
          this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.username_not_found");
          break;
        case "approveSuccess" :
          this.view.lblApproveSend.skin = "sknlblTSSuccess"
          this.view.lblApproveSend.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_approved");
          break;
        case "approveDenied" :
          this.view.lblApproveSend.text = "";
          this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_denied");
          break;
        case "approveTimeOut":
          this.view.lblApproveSend.text = "";
          this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_timeout");
          break;
        case "offlineTSSuccess" :
          this.view.lblTSSuccess.skin="sknlblTSSuccess";
          this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.transaction_success");
          this.commonEventHandler(this.onTSSuccess, "");
          break;  
        case "offlineTSFailure":
          this.view.lblTSSuccess.skin="sknlblTSError";
          this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_failed");
          break; 
        ...
        case "generateChallengeFailure":
          this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.otp_generation_failed_again");
          this.setChallengeUI(false);
          break;    
        case "validateChallengeSuccess" :
          //this.view.flxOTPChallenge.setVisibility(false);
          this.setChallengeUI(false);
          this.view.lblTSSuccessChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.transaction_success");
          this.commonEventHandler(this.onTSSuccess, "");
          break;   
        case "validateChallengeFailure":
          this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_failed");
          this.setChallengeUI(false);
          break;  
        case "sendSMSOTPSuccess":
          this.view.lblsendSMSOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.sms_otp_generated");
          this.setChallengeUI(true);
          break;
        case "sendSMSOTPFailure":
          this.view.lblErrorOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.otp_generation_failed_again");
          this.setChallengeUI(false);
          break;
        case "validateSMSOTPSuccess":
          this.view.lblsendSMSOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.transaction_success");
          this.setChallengeUI(true);
          break;
        case "validateSMSOTPFailure":
          this.view.lblErrorOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.transfer_failed");
          this.setChallengeUI(false);
          break;                
        default:
          alert("Invalid State");
    ...
    initiate :function(){
      if(this._username === ""){
        this.view.lblErrorResponse.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_username");
        return;
      }
      if(this._tds === ""){
        this.view.lblErrorResponse.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_message");
        return;
      }
    ...
    btnLogin_onClick : function(){
      ...
      if(this.toAccount === ""){
        this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_to_account");
        return;
      }
      if(this.amount === ""){
        this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_amount");
        return;
      }      
      if(this.desc === ""){
        this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_description");
        return;
      }
      this.commonEventHandler(this.showLoading, "");
 ...
 //     transactionSigningPresentationController.aprroveTransactInitiate(this.updateTSUI,this._username,toAccount,amount,desc);
  ...
  //      this.contextSwitch("PushDevices");
    ...
    getDeviceFailure : function(response) {
      this.view.lblError.text = kony.i18n.getLocalizedString("i18n.hid.login.no_push_device");
      this.commonEventHandler(this.dismissLoading, "");
    },
    ...
    lblGeneratorQR_onTouchEnd : function(){
      ...
      if(toAccount === ""){
        this.view.lblTSSuccess.skin="sknlblTSError";
        this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_to_account");
        return;
      }
      if(amount === ""){
        this.view.lblTSSuccess.skin="sknlblTSError";
        this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_amount");
        return;
      }
      if(desc === ""){
        this.view.lblTSSuccess.skin="sknlblTSError";
        this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_description");
        return;
      }      
     /* var QRdata = {
        "toAccount" : toAccount,
    ...
    btnLoginOffline_onClick : function(){
      ...
      if(OTP === "" || isNaN(OTP)){
        this.view.lblTSSuccess.skin="sknlblTSError";
        this.view.lblTSSuccess.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_secure_code");
        return;
      }
      this.commonEventHandler(this.showLoading, "");
    ...
    btnGenerateChallenge_onClick : function(){
      ...
      if(toAccount === ""){
        this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_to_account");
        return;
      }
      if(amount === ""){
        this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_amount");
        return;
      } 
      if(desc === ""){
        this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_description");
        return;
      }
      this.commonEventHandler(this.showLoading, "");
      this.correlationId = this.transactionCorrelationIdPrefix + this.generateUUID();
    ...
    btnLoginChallenge_onClick : function(){
      ...
      if(OTP === "" || isNaN(OTP)){
        this.view.lblErrorChallenge.text = kony.i18n.getLocalizedString("i18n.hid.login.enter_otp");
        return;
      }
      this.commonEventHandler(this.showLoading, "");
    ...
    btnSendSMSOtp_onClick : function(){
      ...
      if(toAccount === "" ){
        this.view.lblErrorOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_to_account");
        return;
      }
      if(amount === ""){
        this.view.lblErrorOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_valid_amount");
        return;
      }
      if(message === ""){
        this.view.lblErrorOTP.text = kony.i18n.getLocalizedString("i18n.hid.txn.enter_message");
        return;
      }      
      this.commonEventHandler(this.showLoading, "");
      this.correlationId = this.transactionCorrelationIdPrefix + this.generateUUID();
