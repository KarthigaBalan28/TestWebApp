define({
  ...
  init : function(){
    ...
    this.view.loginComponent.onSuccessCallback = this.onLogin;
    this.view.loginComponent.onFailureCallback = this.onFailure;
  ...
  changeContext : function(context){
    ...
    this.view.lblSwitchSignIn.setVisibility(context === "LoginAuth" || context === "OOBPINAuth" || context === "SecureAuth" || context === "ApproveAuth" || context === "LoginFIDOAuth");
    let contexts = ["Login","ConfirmPassword","OTP","Approve","Error","DeviceRegistration","RegistrationSuccess", "LoginFIDO", "LoginAuth","ApproveAuth","OTPAuth","PushDevicesAuth","OOBPINAuth","SecureAuth", "LoginFIDOAuth"];
  ...
  switchSignIn : function(){
    ...
    setTimeout(()=>{
      ...
      this.view.loginComponent.resetQrUi();
      this.view.onboarding.resetUI();
  ...
  onLogin : function(){
    ...
    var sessionId = this.view.loginComponent.getRmsSessionId();
    //var userId = this.view.onboarding.getUserId();
    //alert(username); 
    var myObj = {"username" : username, "sessionId":sessionId};
    frmAccounts.navigate(myObj);
  },
  onFailure : function(error){
    kony.print("onFailureCallback Error"+JSON.stringify(error));
    }
});
