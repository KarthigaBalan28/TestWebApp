define({ 
  // Do not touch this as it is version 1 implementation
//   resend:false,
//   gblTimer : null,
//   gblCredInfo : "",
//   contexts:["Login","OTP","Approve","OTPFail","MFA","OOBPIN","SecureCode"],
//   mfa_images : {
...
//     this.view.btnLoginOOBPIN.onClick = this.btnLoginOOBPIN_OnClick;
...
//     this.view.btnCancelMFA.onClick = () => {
//         if(this.firstFactor ==="STATIC_PWD"){
//           this.contextSwitch("Login");
//         }else if(this.firstFactor ==="OTP_SMS_PIN"){
...
//   },
//   preShow:function(){
//       this.firstFactor = this.view.loginComponent.FirstFactor;
//       if(this.firstFactor === "STATIC_PWD"){
...
//       } else if(this.firstFactor === "OTP_SMS_PIN"){
//         this.view.lblSigntoAccOOBPIN.text = "Login to your account";
//         this.view.flxUserNameOOBPIN.setVisibility(true);
//         this.view.flxChoose.setVisibility(true);
//         this.view.btnLoginOOBPIN.width="48%";
//         this.view.flxPIN.top = "3%";
//         this.view.flxLoginButton.top = "3%";
//         this.showLoadingIndicator(false);
//       }
...
//       this.contextSwitch("Login"); 
//     } else if(this.firstFactor === "OTP_SMS_PIN") {
//       this.view.tbxUsername.text = this.username;
//       this.contextSwitch("OOBPIN"); 
//     } else{
//       this.contextSwitch("OOBPIN");
//     }
...
//     let factor = this.firstFactor === "STATIC_PWD" ? "first" : "second";
//     this.passwordAuth(factor);
//   },
//   btnLoginOOBPIN_OnClick:function(){
//     if(this.view.tbxUsername.text === ""){
//       this.view.lblLoginError.text = "Please enter UserID";
//       return;
//     }
//     if(this.view.tbxPIN.text === ""){
//       this.view.lblLoginError.text = "Please enter PIN";
//       return;
//     }
//     this.username = this.view.tbxUsername.text;
//     this.password = this.view.tbxPIN.text;
//     this.showLoadingIndicator(true);
//     let factor = this.firstFactor === "OTP_SMS_PIN" ? "first" : "second";
//     this.view.imgOTP.src ="smsotp.png";
//     this.otpCancel = "first";
//     this.sendOTP(this.firstFactor);
//   },
...
//       if(this.firstFactor ==="OTP_SMS_PIN"){
//         self.view.lblLoginError.text= error.message;
//       }else{
...
//     } else if(this.firstFactor === "OTP_SMS_PIN"){
//       this.showLoadingIndicator(true);
//        this.OTPAuth("OTP_SMS_PIN","first");
//     }
//   },
...
//     if(this.firstFactor === "STATIC_PWD"){
//       this.view.tbxPassword.text ="";
//       let name = this.view.tbxUser.text;
//     } else if(this.firstFactor === "OTP_SMS_PIN"){
//       this.view.tbxPIN.text ="";
//       let name = this.view.tbxUsername.text;
//     }
...
//     if(this.firstFactor === "OTP_SMS_PIN"){
//       if(this.view.tbxUsername.text == ""){
//         this.view.lblLoginError.text = "Please Enter Username";
//         return;
//       }
//       this.username = this.view.tbxUsername.text;
//     }else if(this.firstFactor === "STATIC_PWD"){
//       if(this.view.tbxUser.text == ""){
...
//   },
//   NO_Auth: function(authType,factor){
//     this.showLoadingIndicator(true);
//     var self = this;
//     function SCB_ASF(success){
//       this.navigateToAccounts();
//     }
//     function FCB_ASF(error){
//       alert("invalid_grant");
//       this.showLoadingIndicator(false);
//     }
//     if(factor == "second"){
//       this.view.authentication.MFA = authType;
//       this.authenticateSecondFactor("",this.mfa_key,SCB_ASF.bind(this),FCB_ASF.bind(this));
//     }
//   },
...
//        this.sendOTP("OTP_EML");
//     }else if(this.MFA == "NO_MFA"){
//        this.sendOTP("NO_MFA");
//     }else if(this.MFA == "STEP_DOWN"){
//        this.sendOTP("STEP_DOWN");
//     }
//   },
//   secureCode_onClick : function(){
//       let factor = this.firstFactor == "SECURE_CODE" ? "first" : "second";
...
//     alert("Inside setMFAOption with first factor :"+this.firfirstFactor);
...
//     if(authType === "NO_MFA"){
//         let factor = "second";
//         this.NO_Auth(authType, factor);
//       } else if(authType === "OTP_SMS_PIN"){
//          this.otpAuthType = "OTP_SMS";
//          this.view.authentication.sendOTP(authType,this.username,this.password); 
//          this.view.authentication.sendSMSOTPSuccess =
//            success=>{
//            this.firstFactor = "SMS";
//            this.view.btnConfirmOTP.onClick = this.validateOTP;
//            this.view.tbxOTP.onDone = this.validateOTP;
...
//            this.showLoadingIndicator(false);
//            };
//            this.view.authentication.sendSMSOTPFailure = 
//            error=>{
//              this.showLoadingIndicator(false);
//             };
//           } else {
...
//    this.view.authentication.validateOTP();
//   },
