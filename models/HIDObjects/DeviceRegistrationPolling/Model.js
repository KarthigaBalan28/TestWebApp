...
define([], function() {
    ...
    var setterFunctions = {
        ...
        isOnboarding: function(val, state) {
            context["field"] = "isOnboarding";
            context["metadata"] = (objectMetadata ? objectMetadata["isOnboarding"] : null);
            state['isOnboarding'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function DeviceRegistrationPolling(defaultValues) {
        ...
        context["field"] = "deviceStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["deviceStatus"] : null);
        privateState.deviceStatus = defaultValues ?
            (defaultValues["deviceStatus"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["deviceStatus"], context) :
                null) :
            null;
        ...
        context["field"] = "isOnboarding";
        context["metadata"] = (objectMetadata ? objectMetadata["isOnboarding"] : null);
        privateState.isOnboarding = defaultValues ?
            (defaultValues["isOnboarding"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isOnboarding"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "isOnboarding": {
                get: function() {
                    context["field"] = "isOnboarding";
                    context["metadata"] = (objectMetadata ? objectMetadata["isOnboarding"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.isOnboarding, context);
                },
                set: function(val) {
                    setterFunctions['isOnboarding'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.isOnboarding = value ? (value["isOnboarding"] ? value["isOnboarding"] : null) : null;
        };
    }
    ...
    DeviceRegistrationPolling.prototype.objServiceName = "HIDObjects";
