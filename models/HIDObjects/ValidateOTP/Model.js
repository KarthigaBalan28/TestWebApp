...
define([], function() {
    ...
    function ValidateOTP(defaultValues) {
        ...
        context["field"] = "clientId";
        context["metadata"] = (objectMetadata ? objectMetadata["clientId"] : null);
        privateState.clientId = defaultValues ?
            (defaultValues["clientId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["clientId"], context) :
                null) :
            null;
    ...
    ValidateOTP.prototype.objServiceName = "HIDObjects";
