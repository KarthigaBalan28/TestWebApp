...
define([], function() {
    ...
    var setterFunctions = {
        ...
        GetInviteCodeServiceError: function(val, state) {
            context["field"] = "GetInviteCodeServiceError";
            context["metadata"] = (objectMetadata ? objectMetadata["GetInviteCodeServiceError"] : null);
            state['GetInviteCodeServiceError'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function ApproveDeviceRegistration(defaultValues) {
        ...
        context["field"] = "deviceIdOrch";
        context["metadata"] = (objectMetadata ? objectMetadata["deviceIdOrch"] : null);
        privateState.deviceIdOrch = defaultValues ?
            (defaultValues["deviceIdOrch"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["deviceIdOrch"], context) :
                null) :
            null;
        ...
        context["field"] = "scimType";
        context["metadata"] = (objectMetadata ? objectMetadata["scimType"] : null);
        privateState.scimType = defaultValues ?
            (defaultValues["scimType"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["scimType"], context) :
                null) :
            null;
        ...
        context["field"] = "GetInviteCodeServiceError";
        context["metadata"] = (objectMetadata ? objectMetadata["GetInviteCodeServiceError"] : null);
        privateState.GetInviteCodeServiceError = defaultValues ?
            (defaultValues["GetInviteCodeServiceError"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["GetInviteCodeServiceError"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "GetInviteCodeServiceError": {
                get: function() {
                    context["field"] = "GetInviteCodeServiceError";
                    context["metadata"] = (objectMetadata ? objectMetadata["GetInviteCodeServiceError"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.GetInviteCodeServiceError, context);
                },
                set: function(val) {
                    setterFunctions['GetInviteCodeServiceError'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.GetInviteCodeServiceError = value ? (value["GetInviteCodeServiceError"] ? value["GetInviteCodeServiceError"] : null) : null;
        };
    }
    ...
    //For Operation 'getInviteCodeTDSV4B' with service id 'getInviteCode9449'
     ApproveDeviceRegistration.getInviteCodeTDSV4B = function(params, onCompletion){
        return ApproveDeviceRegistration.customVerb('getInviteCodeTDSV4B', params, onCompletion);
     };
    ...
    ApproveDeviceRegistration.prototype.objServiceName = "HIDObjects";
