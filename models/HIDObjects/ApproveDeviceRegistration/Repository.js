define([], function(){
	...
	ApproveDeviceRegistrationRepository.prototype.getInviteCodeTDSV4B = function(params, onCompletion){
		return ApproveDeviceRegistrationRepository.prototype.customVerb('getInviteCodeTDSV4B', params, onCompletion);
	};
