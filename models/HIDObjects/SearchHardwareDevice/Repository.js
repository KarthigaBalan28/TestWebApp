define([], function(){
	...
	SearchHardwareDeviceRepository.prototype.searchDevice = function(params, onCompletion){
		return SearchHardwareDeviceRepository.prototype.customVerb('searchDevice', params, onCompletion);
	};
