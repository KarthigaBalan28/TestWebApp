...
define([], function() {
    ...
    function ActivationCodeValidation(defaultValues) {
        ...
        context["field"] = "activationAuthStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["activationAuthStatus"] : null);
        privateState.activationAuthStatus = defaultValues ?
            (defaultValues["activationAuthStatus"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["activationAuthStatus"], context) :
                null) :
            null;
        ...
        context["field"] = "ActivationCodeError";
        context["metadata"] = (objectMetadata ? objectMetadata["ActivationCodeError"] : null);
        privateState.ActivationCodeError = defaultValues ?
            (defaultValues["ActivationCodeError"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ActivationCodeError"], context) :
                null) :
            null;
        ...
        context["field"] = "ServErrCode";
        context["metadata"] = (objectMetadata ? objectMetadata["ServErrCode"] : null);
        privateState.ServErrCode = defaultValues ?
            (defaultValues["ServErrCode"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ServErrCode"], context) :
                null) :
            null;
        ...
        context["field"] = "validationStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["validationStatus"] : null);
        privateState.validationStatus = defaultValues ?
            (defaultValues["validationStatus"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["validationStatus"], context) :
                null) :
            null;
    ...
    ActivationCodeValidation.prototype.objServiceName = "HIDObjects";
