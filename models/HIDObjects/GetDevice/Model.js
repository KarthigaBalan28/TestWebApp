...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "GetDevice", "objectService" : "HIDObjects"};
    ...
    var setterFunctions = {
        ...
        GetDeviceServiceError: function(val, state) {
            context["field"] = "GetDeviceServiceError";
            context["metadata"] = (objectMetadata ? objectMetadata["GetDeviceServiceError"] : null);
            state['GetDeviceServiceError'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function GetDevice(defaultValues) {
        var privateState = {};
        context["field"] = "deviceId";
        context["metadata"] = (objectMetadata ? objectMetadata["deviceId"] : null);
        ...
        context["field"] = "GetDeviceServiceError";
        context["metadata"] = (objectMetadata ? objectMetadata["GetDeviceServiceError"] : null);
        privateState.GetDeviceServiceError = defaultValues ?
            (defaultValues["GetDeviceServiceError"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["GetDeviceServiceError"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "GetDeviceServiceError": {
                get: function() {
                    context["field"] = "GetDeviceServiceError";
                    context["metadata"] = (objectMetadata ? objectMetadata["GetDeviceServiceError"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.GetDeviceServiceError, context);
                },
                set: function(val) {
                    setterFunctions['GetDeviceServiceError'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "detail": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.GetDeviceServiceError = value ? (value["GetDeviceServiceError"] ? value["GetDeviceServiceError"] : null) : null;
    ...
    BaseModel.isParentOf(GetDevice);

    //Create new class level validator object
    BaseModel.Validator.call(GetDevice);

    var registerValidatorBackup = GetDevice.registerValidator;

    GetDevice.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(GetDevice.isValid(this, propName, val)) {
    ...
    //For Operation 'getDevice' with service id 'getDeviceOnboarding2932'
     GetDevice.getDevice = function(params, onCompletion){
        return GetDevice.customVerb('getDevice', params, onCompletion);
     };

    var relations = [];

    GetDevice.relations = relations;

    GetDevice.prototype.isValid = function() {
        return GetDevice.isValid(this);
    };

    GetDevice.prototype.objModelName = "GetDevice";
    GetDevice.prototype.objServiceName = "HIDObjects";
     ...
     */
    GetDevice.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDObjects", "GetDevice", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    GetDevice.clone = function(objectToClone) {
        var clonedObj = new GetDevice();
