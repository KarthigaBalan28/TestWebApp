...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Devices", "objectService" : "HIDTransactionSigning"};
    ...
    Devices.prototype.objServiceName = "HIDTransactionSigning";
    ...
    Devices.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDTransactionSigning", "Devices", options, metaDataSuccess, metaDataFailure);
    };
