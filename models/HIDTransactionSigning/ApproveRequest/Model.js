...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ApproveRequest", "objectService" : "HIDTransactionSigning"};
    ...
    ApproveRequest.prototype.objServiceName = "HIDTransactionSigning";
    ...
    ApproveRequest.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDTransactionSigning", "ApproveRequest", options, metaDataSuccess, metaDataFailure);
    };
