...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "User", "objectService" : "HIDTransactionSigning"};
    ...
    //For Operation 'searchUser' with service id 'SearchUserAuth2828'
     User.searchUser = function(params, onCompletion){
        return User.customVerb('searchUser', params, onCompletion);
     };
    ...
    User.prototype.objServiceName = "HIDTransactionSigning";
    ...
    User.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDTransactionSigning", "User", options, metaDataSuccess, metaDataFailure);
    };
