...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ValidateSecureCode", "objectService" : "HIDUserManagement"};
    ...
    ValidateSecureCode.prototype.objServiceName = "HIDUserManagement";
    ...
    ValidateSecureCode.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "ValidateSecureCode", options, metaDataSuccess, metaDataFailure);
    };
