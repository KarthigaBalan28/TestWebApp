...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DeviceRegistrationPolling", "objectService" : "HIDUserManagement"};
    ...
    //For Operation 'deviceRegistrationPolling' with service id 'getHIDDeviceRegistrationStatus6207'
    ...
    DeviceRegistrationPolling.prototype.objServiceName = "HIDUserManagement";
    ...
    DeviceRegistrationPolling.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "DeviceRegistrationPolling", options, metaDataSuccess, metaDataFailure);
    };
