...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "PasswordPolicy", "objectService" : "HIDUserManagement"};
    ...
    var setterFunctions = {
        ...
        notOldPassword: function(val, state) {
            context["field"] = "notOldPassword";
            context["metadata"] = (objectMetadata ? objectMetadata["notOldPassword"] : null);
            state['notOldPassword'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function PasswordPolicy(defaultValues) {
        ...
        context["field"] = "notOldPassword";
        context["metadata"] = (objectMetadata ? objectMetadata["notOldPassword"] : null);
        privateState.notOldPassword = defaultValues ?
            (defaultValues["notOldPassword"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["notOldPassword"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "notOldPassword": {
                get: function() {
                    context["field"] = "notOldPassword";
                    context["metadata"] = (objectMetadata ? objectMetadata["notOldPassword"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.notOldPassword, context);
                },
                set: function(val) {
                    setterFunctions['notOldPassword'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "notSequence": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.notOldPassword = value ? (value["notOldPassword"] ? value["notOldPassword"] : null) : null;
    ...
    //For Operation 'getPolicy' with service id 'getPasswordPolicy8892'
     PasswordPolicy.getPolicy = function(params, onCompletion){
        return PasswordPolicy.customVerb('getPolicy', params, onCompletion);
     };
    ...
    PasswordPolicy.prototype.objServiceName = "HIDUserManagement";
    ...
    PasswordPolicy.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "PasswordPolicy", options, metaDataSuccess, metaDataFailure);
    };
