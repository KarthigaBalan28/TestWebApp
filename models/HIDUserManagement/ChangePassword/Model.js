...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ChangePassword", "objectService" : "HIDUserManagement"};

    var setterFunctions = {
        ChangePasswordError: function(val, state) {
            context["field"] = "ChangePasswordError";
            context["metadata"] = (objectMetadata ? objectMetadata["ChangePasswordError"] : null);
            state['ChangePasswordError'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function ChangePassword(defaultValues) {
        ...
        context["field"] = "ChangePasswordError";
        context["metadata"] = (objectMetadata ? objectMetadata["ChangePasswordError"] : null);
        privateState.ChangePasswordError = defaultValues ?
            (defaultValues["ChangePasswordError"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ChangePasswordError"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            "ChangePasswordError": {
                get: function() {
                    context["field"] = "ChangePasswordError";
                    context["metadata"] = (objectMetadata ? objectMetadata["ChangePasswordError"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.ChangePasswordError, context);
                },
                set: function(val) {
                    setterFunctions['ChangePasswordError'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "password": {
        ...
        this.fromJsonInternal = function(value) {
            privateState.ChangePasswordError = value ? (value["ChangePasswordError"] ? value["ChangePasswordError"] : null) : null;
    ...
    //For Operation 'ChangePwd' with service id 'changeUserPassword5812'
     ChangePassword.ChangePwd = function(params, onCompletion){
        return ChangePassword.customVerb('ChangePwd', params, onCompletion);
     };
    ...
    ChangePassword.prototype.objServiceName = "HIDUserManagement";
    ...
    ChangePassword.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "ChangePassword", options, metaDataSuccess, metaDataFailure);
    };
