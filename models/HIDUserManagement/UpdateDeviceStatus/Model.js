...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "UpdateDeviceStatus", "objectService" : "HIDUserManagement"};
    ...
    //For Operation 'updateDeviceStatus' with service id 'updateDeviceStatus9211'
    ...
    UpdateDeviceStatus.prototype.objServiceName = "HIDUserManagement";
    ...
    UpdateDeviceStatus.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "UpdateDeviceStatus", options, metaDataSuccess, metaDataFailure);
    };
