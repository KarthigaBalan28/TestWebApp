...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "SearchDevices", "objectService" : "HIDUserManagement"};
    ...
    SearchDevices.prototype.objServiceName = "HIDUserManagement";
    ...
    SearchDevices.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDUserManagement", "SearchDevices", options, metaDataSuccess, metaDataFailure);
    };
