...
define([], function() {
    ...
    var setterFunctions = {
        ...
        signals: function(val, state) {
            context["field"] = "signals";
            context["metadata"] = (objectMetadata ? objectMetadata["signals"] : null);
            state['signals'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function RMSActionCreate(defaultValues) {
        ...
        context["field"] = "signals";
        context["metadata"] = (objectMetadata ? objectMetadata["signals"] : null);
        privateState.signals = defaultValues ?
            (defaultValues["signals"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["signals"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "signals": {
                get: function() {
                    context["field"] = "signals";
                    context["metadata"] = (objectMetadata ? objectMetadata["signals"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.signals, context);
                },
                set: function(val) {
                    setterFunctions['signals'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.signals = value ? (value["signals"] ? value["signals"] : null) : null;
        };
    }
