define([], function(){
	...
	DevicesRepository.prototype.searchDeviceCantSignIn = function(params, onCompletion){
		return DevicesRepository.prototype.customVerb('searchDeviceCantSignIn', params, onCompletion);
	};
