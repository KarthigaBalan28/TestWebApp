...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ApproveStatus", "objectService" : "HIDAuthService"};
    ...
    var setterFunctions = {
        ...
        usercode: function(val, state) {
            context["field"] = "usercode";
            context["metadata"] = (objectMetadata ? objectMetadata["usercode"] : null);
            state['usercode'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function ApproveStatus(defaultValues) {
        ...
        context["field"] = "usercode";
        context["metadata"] = (objectMetadata ? objectMetadata["usercode"] : null);
        privateState.usercode = defaultValues ?
            (defaultValues["usercode"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["usercode"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "usercode": {
                get: function() {
                    context["field"] = "usercode";
                    context["metadata"] = (objectMetadata ? objectMetadata["usercode"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.usercode, context);
                },
                set: function(val) {
                    setterFunctions['usercode'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "auth_key": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.usercode = value ? (value["usercode"] ? value["usercode"] : null) : null;
    ...
    //For Operation 'pollForCantSignIn' with service id 'pollForCantSignIn7949'
     ApproveStatus.pollForCantSignIn = function(params, onCompletion){
        return ApproveStatus.customVerb('pollForCantSignIn', params, onCompletion);
     };
    ...
    ApproveStatus.prototype.objServiceName = "HIDAuthService";
    ...
    ApproveStatus.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("HIDAuthService", "ApproveStatus", options, metaDataSuccess, metaDataFailure);
    };
