define([], function(){
	...
	ApproveStatusRepository.prototype.pollForCantSignIn = function(params, onCompletion){
		return ApproveStatusRepository.prototype.customVerb('pollForCantSignIn', params, onCompletion);
	};
